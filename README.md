...
Raccoon Music Player is a pocket-sized music player that shows an animation of dancing raccoons while songs are playing. Made as a proof-of-concept Python app based on the excellent [Dear PyGui](https://github.com/hoffstadt/DearPyGui/) and [PyMiniAudio](https://github.com/irmen/pyminiaudio) libraries, the project was created for the purpose of learning Python and gaining familiarity with the aforementioned libraries. As the focus of this project was on learning and creating something fun, the music player is minimalistic by design.
